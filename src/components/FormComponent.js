...
const mapStateToProps = (state) => {
  return {
    initialValues: {
      ...
      category: state.users.getUserDetail.category,
      amount: state.users.getUserDetail.amount,
    },
  };
};
    ...
    return (
      <form onSubmit={this.props.handleSubmit}>
        <FormGroup row>
          ...
          <Col md={6}>
            <FormGroup>
              <Field type="text" name="category" component={renderField} label="Category :" />
            </FormGroup>
          </Col>

          <Col md={6}>
            <FormGroup>
              <Field type="number" name="amount" component={renderField} label="Amount :" />
            </FormGroup>
          </Col>
        </FormGroup>
